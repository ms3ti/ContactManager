...
using OutSystems.CachingCommon.Configuration;
...
namespace OutSystems.CachingCommon {
    ...
    public class PubSubCache : ICache {
        ...
        protected PubSubCache(IPubSub pubSubProvider, ISettingsProvider settingsProvider, string cacheInstanceKey = null) {
            ...
            if (GetSettingDictionaryStorageCache(settingsProvider)) {
                this.filter = new InvalidationFilterWithGuidDictionary();
            } else {
        ...
        public void Invalidate(ICacheInvalidationKey dependency) {
            ...
            try {
                pubSub.Publish(topic, filter.GetInstanceKey());
            } catch (Exception) {
                // TODO: Log error.
        ...
        private bool GetSettingDictionaryStorageCache(ISettingsProvider settingsProvider) {
            if (settingsProvider != null) {
                return settingsProvider.Get(CacheSettings.EnableDictionaryStorageCache);
            } else {
                return true;
            }
        }
