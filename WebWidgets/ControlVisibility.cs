...
namespace OutSystems.HubEdition.WebWidgets {
    public class ControlVisibility {
        ...
        public void RestoreChildControlVisibility(string id) {
            ...
            if ((visibilityDictionary != null) && visibilityDictionary.TryGetValue(id, out bool wasInvisible)) {
        ...
        public bool GetSavedOwnerControlVisibility() {
            ...
            if ((visibilityDictionary != null) && visibilityDictionary.TryGetValue(OWNER_KEY_IN_VISIBILITY_DICTIONARY, out bool wasInvisible)) {
                return !wasInvisible;
            } else {
                return true;
            }
