...
namespace OutSystems.RESTService.Controllers {
    public sealed class RestServiceControllerConfiguration : Attribute, IControllerConfiguration, IBehaviorsConfiguration {
        public RestServiceControllerConfiguration() {
            // Force defaults here
            DefaultValuesBehavior = DefaultValuesBehavior.DontSend;
            HTTPSecurity = HTTPSecurity.None;
        ...
        public JsonSerializerSettings SerializerSettings => CustomJsonMediaTypeFormatter.GetInstance(this).SerializerSettings;
        ...
        public void Initialize(HttpControllerSettings controllerSettings, HttpControllerDescriptor controllerDescriptor) {
            ...
            // Add our Text formatter to handle all text/* and application/x-www-form-urlencoded content-types in methods that receive a basic data type in body
        ...
        public object Clone() {
            var clone = (RestServiceControllerConfiguration)MemberwiseClone();
            clone.BinariesUsed = new HashSet<string>(BinariesUsed);
            return clone;
        }
    }
}
