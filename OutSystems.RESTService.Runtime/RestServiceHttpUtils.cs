...
namespace OutSystems.RESTService {
    public static class RestServiceHttpUtils {
        ...
        private const string HttpItemContentType = "Content-Type";

        /// <summary>
        /// Tries to get a Header from the request if present
        /// </summary>
        ...
        private static MediaTypeHeaderValue TryGetResponseContentHeader(HttpResponseMessage response) {
            ...
            if (HttpService.Context != null) {
                ...
                string overridenContentType = HttpService.Context.Items[HttpItemContentType] as string;

                if (!string.IsNullOrEmpty(overridenContentType)) {
                    return MediaTypeHeaderValue.TryParse(overridenContentType, out MediaTypeHeaderValue outVal) ? outVal : null;
                }
            }
        ...
        public static MediaTypeHeaderValue GetRequestContentType(HttpRequest request) {
            return GetRequestContentType(HttpService.Context.Request);
        }

        public static MediaTypeHeaderValue GetRequestContentType(IHttpRequest request) {
        ...
        public static MediaTypeHeaderValue TryGetRequestContentType(HttpRequest request, string defaultValue) {
            return TryGetRequestContentType(HttpService.Context.Request, defaultValue);
        }

        public static MediaTypeHeaderValue TryGetRequestContentType(IHttpRequest request, string defaultValue) {
            try {
                return ParseContentType(request.ContentType);
            } catch {
        ...
        public static HttpStatusCode GetCurrentStatusCode() {
            return (HttpStatusCode)HttpService.Context.Response.StatusCode;
        }
        ...
        public static byte[] ReadRequestContent(HttpRequestMessage requestMessage) {
            ...
            byte[] content = System.Array.Empty<byte>();
            if (requestMessage.Content != null) {
                requestMessage.Content.ReadAsByteArrayAsync()
                    .ContinueWith((task) => {
                        content = task.Result;
