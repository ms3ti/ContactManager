    ...
    public class ServiceConfiguration : LifecyleListener {
        ...
        private class RESTServiceControllerTypeResolver : DefaultHttpControllerTypeResolver {
            public override ICollection<Type> GetControllerTypes(IAssembliesResolver assembliesResolver) {
                HashSet<Type> allControllers = base.GetControllerTypes(assembliesResolver).LegacyToHashSet();
        ...
        // source: https://stackoverflow.com/a/34742785
        public class WebApiCustomDirectRouteProvider : DefaultDirectRouteProvider {
            ...
            protected override string GetRoutePrefix(HttpControllerDescriptor controllerDescriptor) {
                ...
                if (RuntimePlatformSettings.Application.IsALDEnabled.GetValue() && !controllerDescriptor.ControllerName.Contains("ModuleServices")) {
                    var appInfo = AppInfo.GetAppInfo();
                    var centralizedPrefix = appInfo.eSpaceName;

                    var existingPrefix = base.GetRoutePrefix(controllerDescriptor);
                    if (existingPrefix == null) {
                        return centralizedPrefix;
                    }

                    return string.Format("{0}/{1}", centralizedPrefix, existingPrefix);
                }
        ...
        public static void Initialize() {
            if (!routesInitialized) {
                ...
                GlobalConfiguration.Configuration.MapHttpAttributeRoutes(new WebApiCustomDirectRouteProvider());
