...
namespace OutSystems.HubEdition.Extensibility.Data.ConfigurationService {
    ...
    public enum ParameterRegion {
        UserSpecific = 0x01,
        DatabaseLocation = 0x02,
        SessionDatabaseLocation = 0x04,
    ...
    public sealed class HelpLinkForEnumConfigurationParameter : Attribute, IHelpLinkForPluginEnumConfiguration {
