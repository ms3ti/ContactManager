...
namespace OutSystems.HubEdition.Extensibility.Data.ExecutionService {
    ...
    public abstract class BaseExecutionService : IExecutionService {
        ...
        public IDatabasePropertiesService DatabasePropertiesService { get; protected internal set; }
        ...
        /// </summary>
        public virtual IDatabaseServices DatabaseServices { get; }
		...
		public virtual IDbCommand CreateCommand(IDbTransaction trans, string sql) {
            IDbCommand cmd = CreateCommand(trans.Connection);
        ...
        public virtual DbType ConvertToDbType(DBDataType type, string providerType) {
            return type switch {
                DBDataType.TEXT => DbType.String,
                DBDataType.INTEGER => DbType.Int32,
                DBDataType.LONGINTEGER => DbType.Int64,
                DBDataType.DECIMAL => DbType.Decimal,
                DBDataType.DATE_TIME => DbType.DateTime,
                DBDataType.DATE => DbType.Date,
                DBDataType.TIME => DbType.Time,
                DBDataType.BOOLEAN => DbType.Boolean,
                DBDataType.BINARY_DATA => DbType.Binary,
                _ => throw new NotSupportedException("Unable to convert " + type + " to DbType")
            };
        }
		...
		public virtual bool IsTimeoutException(Exception exception) {
            return exception is DbException dbException && dbException.ErrorCode == TimeoutErrorCode;
		}
