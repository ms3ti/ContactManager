...
namespace OutSystems.HubEdition.Extensibility.Data.Platform.Configuration {
    public abstract class AbstractTwoUserDatabaseConfiguration : ITwoUserDatabaseConfiguration {
        ...
        public virtual string DefaultAdminUser { get; } = "OSADMIN";
        public virtual string DefaultRuntimeUser { get; } = "OSRUNTIME";
        ...
        public virtual void Set(IPlatformDatabaseConfiguration conf) {
        ...
        public string RuntimeUser {
            get {
                return runtimeUser ?? DefaultRuntimeUser;
            }
            set {
                runtimeUser = value;
            }
