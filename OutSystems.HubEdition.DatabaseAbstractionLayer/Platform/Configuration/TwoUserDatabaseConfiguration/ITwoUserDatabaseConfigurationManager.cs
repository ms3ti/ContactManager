...
using OutSystems.HubEdition.DatabaseAbstractionLayer.Platform.Configuration.BaseConfigurationObjects;
...
namespace OutSystems.HubEdition.Extensibility.Data.Platform.Configuration {
    ...
    public interface ITwoUserDatabaseConfigurationManager : IBaseConfigurationManager {
        ...
        /// </summary>
        /// <returns></returns>
        DatabaseScriptParser CreateDatabaseScriptParser();
        ...
        IEnumerable<DatabaseScriptBlock> GetDatabaseScriptStatements(Version currentModelVersion);
        ...
        /// <returns>Set of statements to execute. This includes tagged statements (--%TAG%)</returns>
        IEnumerable<DatabaseScriptBlock> GetDatabaseScriptStatements(Version currentModelVersion, IEnumerable<IDatabaseScriptFile> databaseScriptFiles);
