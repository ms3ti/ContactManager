...
namespace OutSystems.HubEdition.Extensibility.Data.Platform.Configuration {
    public abstract class AbstractPlatformDatabaseConfiguration : AbstractTwoUserDatabaseConfiguration, IPlatformDatabaseConfiguration {
        ...
        public override IRuntimeDatabaseConfiguration RuntimeDatabaseConfiguration(UserType user) {
            return RuntimeDatabaseConfiguration(Source.Application, user);
        }
