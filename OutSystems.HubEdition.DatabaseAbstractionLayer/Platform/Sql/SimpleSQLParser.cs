...
namespace OutSystems.HubEdition.Extensibility.Data.Platform.Sql {
    ...
    public abstract class SimpleSQLParser {
        ...
        protected static readonly Regex sqlComments = new Regex(@"/\*[\s\S]*?\*/", RegexOptions.Compiled);
        protected static readonly Regex sqlCommentsWithoutHints = new Regex(@"/\*[^\+][\s\S]*?\*/", RegexOptions.Compiled);
        protected static readonly Regex sqlLiterals = new Regex(@"/\*[\s\S]*?\*/|'[^']*'|""[^""]*""", RegexOptions.Compiled);
