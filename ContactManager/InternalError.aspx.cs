	...
	public class ScrnInternalError: OSPageViewStateCompressed, IWebScreen, INegotiateTabIndexes, IBookmarkableURL {
		...
		protected void InitializeUrls() {
			...
			if (Request.AppRelativeCurrentExecutionFilePath.IndexOf('/', 2) == -1) {
				...
				actionUrl += AppUtils.GetPageName(heContext, AppUtils.eSpaceId, "InternalError", parameters,/*useParamsOnlyIfNeededForRule*/ true);
			}
			bookmarkableUrl += AppUtils.GetPageName(heContext, AppUtils.eSpaceId, "InternalError", parameters,/*useParamsOnlyIfNeededForRule*/ false);
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			if (!IsPostBack) {
				ArrayList screenParameters = (ArrayList) AppUtils.App.OsContext.Session["ContactManager._ScreenParameters_InternalError"];
				...
				if ((screenParametersKey == null || this.Key.Equals(ObjectKey.Parse(Convert.ToString(screenParametersKey)))) && screenParameters != null) {
					try {
						...
						AppUtils.App.OsContext.Session["ContactManager._ScreenParameters_InternalError"] = null;
		...
		public string expression_InlineExpression13() {
			return ((string) AppUtils.App.OsContext.Session["ExceptionMessage"]);
		}
		/// <summary>
