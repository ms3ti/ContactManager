...
namespace ssContactManager {
	...
	public class Image: System.Web.UI.Page {
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			object tmpHash = RuntimeCache.Instance.Get(new OutSystems.RuntimeCommon.Caching.CacheKey("DbImage/" + _entity + "/" + _attribute + "/" + _id + "/" + _filename));
			if ((!refreshItem) && (tmpHash != null)) {
				...
				if (dbimgconfig.CacheTime != 0) {
					...
					RuntimeCache.Instance.Add(new OutSystems.RuntimeCommon.Caching.CacheKey("DbImage/" + _entity + "/" + _attribute + "/" + _id + "/" + _filename), new DbImgCacheFile(md5Hash, buffer), null, absoluteexpire, OutSystems.RuntimeCommon.Caching.CacheUtils.NoSliding, OutSystems.RuntimeCommon.Caching.CacheItemPriority.Removable);
				}
			}
