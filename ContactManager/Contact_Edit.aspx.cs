	...
	public class ScrnContact_Edit: OSPageViewStateCompressed, IWebScreen, INegotiateTabIndexes, IBookmarkableURL {
		...
		protected void InitializeUrls() {
			...
			if (Request.AppRelativeCurrentExecutionFilePath.IndexOf('/', 2) == -1) {
				...
				actionUrl += AppUtils.GetPageName(heContext, AppUtils.eSpaceId, "Contact_Edit", parameters,/*useParamsOnlyIfNeededForRule*/ true);
			}
			bookmarkableUrl += AppUtils.GetPageName(heContext, AppUtils.eSpaceId, "Contact_Edit", parameters,/*useParamsOnlyIfNeededForRule*/ false);
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			if (!IsPostBack) {
				ArrayList screenParameters = (ArrayList) AppUtils.App.OsContext.Session["ContactManager._ScreenParameters_Contact_Edit"];
				...
				if ((screenParametersKey == null || this.Key.Equals(ObjectKey.Parse(Convert.ToString(screenParametersKey)))) && screenParameters != null) {
					try {
						...
						AppUtils.App.OsContext.Session["ContactManager._ScreenParameters_Contact_Edit"] = null;
					...
					if ((wtContactEdit_Valid())) {
						...
						if (OSPage.IsAjaxRequest) {
							// go to target page
							{
								...
								AppUtils.App.OsContext.Session["ContactManager._ScreenParameters_Contact_List"] = screenParameters;
								string sURLQuery = null;
								sURLQuery = (sURLQuery == null ? "": "?" + sURLQuery);
								string sURL = GetClientRedirectionUrlBasePath(AppUtils.App.IsForcingSecurityForScreens(), AppUtils.Instance.GetImagePath(), "", "") + "Contact_List.aspx" + sURLQuery;
		...
		public string lnk_Link32_NavigateUrl() {
			...
			navUrl += AppUtils.GetPageName(heContext, AppUtils.eSpaceId, "Contact_List", parameters);
		...
		public static class FuncssPreparation {
			...
			public static RLContactRecordList datasetGetContactById(HeContext heContext, int maxRecords, IterationMultiplicity multiplicity, out long outParamCount, int qpinId) {
				...
				using(var sqlCmd = trans.CreateCommand()) {
					...
					sql = "/* ContactManager.MainFlow.Contact_Edit.Preparation.GetContactById */" + sql;
