...
namespace ssContactManager {
	public partial class ExtendedActions {
		...
		public static readonly ObjectKey roAnonymousOwnerEspaceKey = ObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA");
		public static readonly ObjectKey rRegisteredKey = ObjectKey.Parse("I1Fm79oZdUu8QBe+dLY9Cg");
		public static readonly ObjectKey roRegisteredOwnerEspaceKey = ObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA");
		/// <summary>
