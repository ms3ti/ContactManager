...
namespace ssContactManager.Flows.FlowRichWidgets {
	public abstract class WBlkFeedback_Message: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent, INotifyTriggers, INotifySender {
			...
			try {
				...
				do {
					if ((BuiltInFunction.IsLoadingScreen())) {
						...
						varLcMessageText = ((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]).ssSTFeedback_Message.ssMessageText;
						// MessageType = Feedback_Message.Feedback_Message.MessageType
						varLcMessageType = ((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]).ssSTFeedback_Message.ssMessageType;
						// Feedback_Message.Feedback_Message.MessageText = ""
						RCFeedback_MessageRecord CompID_Aux_2 = ((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]);
						CompID_Aux_2.ssSTFeedback_Message.ssMessageText = "";
						AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"] = CompID_Aux_2;
						// Feedback_Message.Feedback_Message.MessageType = NullIdentifier
						RCFeedback_MessageRecord CompID_Aux_3 = ((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]);
						CompID_Aux_3.ssSTFeedback_Message.ssMessageType = BuiltInFunction.NullIdentifier();
						AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"] = CompID_Aux_3;
					} else {
					...
					Actions.ActionSetCookie(heContext, "pageLoadedFromBrowserCache", "false", 0, "/", "", false, false, "");
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			heContext = AppUtils.App.OsContext;
			RuntimeID = ClientID;
			IncludeSpan = true;
			if (!Visible) return;
			ObjectKey oldCurrentESpaceKey = heContext.CurrentESpaceKey;
		...
		private bool CommandRefresh(HeContext heContext) {
			...
			try {
				...
				if (((Functions.rssespaceservicecenter_Deprecated_NotifyGetMessage(heContext) != ""))) {
					...
					// Feedback_Message.Feedback_Message.MessageType = NullIdentifier
					RCFeedback_MessageRecord CompID_Aux_4 = ((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]);
					CompID_Aux_4.ssSTFeedback_Message.ssMessageType = BuiltInFunction.NullIdentifier();
					AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"] = CompID_Aux_4;
					explicitChangedVariables.Add(((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]).ssSTFeedback_Message.ssMessageType);

					// Feedback_Message.Feedback_Message.MessageText = ""
					RCFeedback_MessageRecord CompID_Aux_5 = ((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]);
					CompID_Aux_5.ssSTFeedback_Message.ssMessageText = "";
					AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"] = CompID_Aux_5;
					explicitChangedVariables.Add(((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]).ssSTFeedback_Message.ssMessageText);
					...
					// Feedback_Message.Feedback_Message.MessageText = ""
					RCFeedback_MessageRecord CompID_Aux_6 = ((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]);
					CompID_Aux_6.ssSTFeedback_Message.ssMessageText = "";
					AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"] = CompID_Aux_6;
					explicitChangedVariables.Add(((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]).ssSTFeedback_Message.ssMessageText);

					// Feedback_Message.Feedback_Message.MessageType = NullIdentifier
					RCFeedback_MessageRecord CompID_Aux_7 = ((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]);
					CompID_Aux_7.ssSTFeedback_Message.ssMessageType = BuiltInFunction.NullIdentifier();
					AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"] = CompID_Aux_7;
					explicitChangedVariables.Add(((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]).ssSTFeedback_Message.ssMessageType);
