	...
	public abstract class WBlkList_SortColumn: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent, INotifyTriggers, INotifySender {
		...
		private bool Commandsort(HeContext heContext) {
			...
			try {
				...
				ExtendedActions.Deprecated_Notify(heContext, this, ((inParamColumn+ " ") +localVars.varLcDirection));
		...
		public string expression_InlineExpression6() {
			...
			try {
				heContext.CurrentESpaceKey = ssContactManager.AppUtils.eSpaceKey;
				return (((((((((("<script type=\'text/javascript\'>\r\n      RichWidgets_List_SortColumn(\'" +inParamColumn) + "\',\'") +wtlnkSort.ClientID) + "\',\'") + ((string) AppUtils.App.OsContext.Session["ContactManager.SortColumn_OrderBy"])) + "\',\'") +Functions.rssextensionhttprequesthandler_ActionGetPageName(heContext)) + "\', \'") +this.FindControl("wttxtTableRecordsId").ClientID) + "\');\r\n </script>");
			} finally {
				heContext.CurrentESpaceKey = oldCurrentESpaceKey;
			}
		}
