	...
	public partial class Actions {
		...
		public static void ActionList_SortColumn_GetOrderBy(HeContext heContext, string inParamTableRecordId, string inParamDefaultOrder, out string outParamOrderBy) {
			...
			try {
				...
				result.outParamOrderBy = Functions.ActionPrivate_HashGet(heContext, ((string) AppUtils.App.OsContext.Session["ContactManager.SortColumn_OrderBy"]), ((Functions.rssextensionhttprequesthandler_ActionGetPageName(heContext) + ":") +localVars.inParamTableRecordId));
				// Exists?
