			...
			try {
				...
				if (((localVars.inParamStartIndexOverride!=(-1)))) {
					...
					if ((((localVars.inParamRememberStartIndex==false) &&BuiltInFunction.IsLoadingScreen()))) {
						...
						localVars.varLcListIndex_Text = Functions.ActionPrivate_HashGet(heContext, ((string) AppUtils.App.OsContext.Session["ContactManager.ListNavigation_StartIndices"]), ((Functions.rssextensionhttprequesthandler_ActionGetPageName(heContext) + ":") +localVars.inParamListWidget));
						// Found Key?
						...
						AppUtils.App.OsContext.Session["ContactManager.ListNavigation_RememberStartIndices"] = BuiltInFunction.Replace(((string) AppUtils.App.OsContext.Session["ContactManager.ListNavigation_RememberStartIndices"]), (((Functions.rssextensionhttprequesthandler_ActionGetPageName(heContext) + ":") +localVars.inParamListWidget) + ";"), "");
						// RememberStartIndex?
						if ((localVars.inParamRememberStartIndex)) {
							...
							AppUtils.App.OsContext.Session["ContactManager.ListNavigation_RememberStartIndices"] = ((((((string) AppUtils.App.OsContext.Session["ContactManager.ListNavigation_RememberStartIndices"]) +Functions.rssextensionhttprequesthandler_ActionGetPageName(heContext)) + ":") +localVars.inParamListWidget) + ";");
						}
