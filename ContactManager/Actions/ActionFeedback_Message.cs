...
namespace ssContactManager {
	...
	public partial class Actions {
		...
		public static void ActionFeedback_Message(HeContext heContext, string inParamMessageText, int inParamMessageType) {
			...
			RCFeedback_MessageRecord CompID_Aux_0 = ((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]);
			CompID_Aux_0.ssSTFeedback_Message.ssMessageText = localVars.inParamMessageText;
			AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"] = CompID_Aux_0;
			// Feedback_Message.Feedback_Message.MessageType = MessageType
			RCFeedback_MessageRecord CompID_Aux_1 = ((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]);
			CompID_Aux_1.ssSTFeedback_Message.ssMessageType = localVars.inParamMessageType;
			AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"] = CompID_Aux_1;
			...
			// "
			localVars.varLcJS = (((((((((localVars.varLcJS+ "if ((function(obj, prop){var a = false;\r\n    try {\r\n        a = typeof(obj) != \'undefined\' && (obj[prop]===obj[prop]);\r\n    } catch (ex) { a = false; }\r\n    return a;})(parent,\'RichWidgets_Feedback_Message_notifyWidget\') && parent.RichWidgets_Feedback_Message_notifyWidget)  {\r\n parent.OsNotifyWidget(parent.RichWidgets_Feedback_Message_notifyWidget,\'") +Convert.ToString(((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]).ssSTFeedback_Message.ssMessageType)) + " ") +BuiltInFunction.EncodeJavascript(localVars.inParamMessageText)) + "\');\r\n} else\r\n OsNotifyWidget(RichWidgets_Feedback_Message_notifyWidget,\'") +Convert.ToString(((RCFeedback_MessageRecord) AppUtils.App.OsContext.Session["ContactManager.Feedback_Message"]).ssSTFeedback_Message.ssMessageType)) + " ") +BuiltInFunction.EncodeJavascript(localVars.inParamMessageText)) + "\');\r\n");
			// JSNotifyFeedback
			if (heContext != null) {
				heContext.RequestCancelation.ThrowIfCanceled();
			}
