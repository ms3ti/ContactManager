...
namespace ssContactManager {
	...
	public partial class RssExtensionHTTPRequestHandler {
		...
		/// </summary>
		protected static OutSystems.NssHTTPRequestHandler.IssHTTPRequestHandler issHTTPRequestHandler = (OutSystems.NssHTTPRequestHandler.IssHTTPRequestHandler) ServiceLocator.GetService<OutSystems.NssHTTPRequestHandler.CssHTTPRequestHandler>();
			...
			try {
				...
				(heContext.AppInfo.ExtensionProperties.AllowLogging("b1ef216b-d67f-454e-9f01-a7f0274608d6") && heContext.AppInfo.Properties.AllowLogging))) {
					...
					if (extLogCount == _maxExtensionLogsPerRequest) {
						...
						instant, executionDuration, "GetURLMethod", errorLogId, 14, "HTTPRequestHandler");
						heContext.ExtensionLogCount = extLogCount + 1;
			...
			try {
				...
				(heContext.AppInfo.ExtensionProperties.AllowLogging("b1ef216b-d67f-454e-9f01-a7f0274608d6") && heContext.AppInfo.Properties.AllowLogging))) {
					...
					if (extLogCount == _maxExtensionLogsPerRequest) {
						...
						int executionDuration = Convert.ToInt32(DateTime.Now.Subtract(startTime).TotalMilliseconds);
						ExtensionLog.StaticWrite(heContext.AppInfo, heContext.Session,
						instant, executionDuration, "IsAjaxRequest", errorLogId, 14, "HTTPRequestHandler");
						heContext.ExtensionLogCount = extLogCount + 1;
						RequestTracer reqTracer = heContext.RequestTracer;
						if (reqTracer != null) {
		...
		public static void MssSetCookie(HeContext heContext, string inParamCookieName, string inParamCookieValue, int inParamCookieExpirationSpan, string inParamCookiePath, string inParamCookieDomain, bool inParamCookieHttpOnly, bool inParamCookieSecure, string inParamCookieSameSite) {
			DateTime startTime = DateTime.Now;
			String errorLogId = "";
			try {
				if (heContext != null) {
				...
				issHTTPRequestHandler.MssSetCookie(inParamCookieName, inParamCookieValue, inParamCookieExpirationSpan, inParamCookiePath, inParamCookieDomain, inParamCookieHttpOnly, inParamCookieSecure, inParamCookieSameSite);
			} catch (Exception ex) {
				...
				(heContext.AppInfo.ExtensionProperties.AllowLogging("b1ef216b-d67f-454e-9f01-a7f0274608d6") && heContext.AppInfo.Properties.AllowLogging))) {
					...
					if (extLogCount == _maxExtensionLogsPerRequest) {
						...
						int executionDuration = Convert.ToInt32(DateTime.Now.Subtract(startTime).TotalMilliseconds);
						ExtensionLog.StaticWrite(heContext.AppInfo, heContext.Session,
						instant, executionDuration, "SetCookie", errorLogId, 14, "HTTPRequestHandler");
						heContext.ExtensionLogCount = extLogCount + 1;
						RequestTracer reqTracer = heContext.RequestTracer;
						if (reqTracer != null) {
			...
			try {
				...
				(heContext.AppInfo.ExtensionProperties.AllowLogging("b1ef216b-d67f-454e-9f01-a7f0274608d6") && heContext.AppInfo.Properties.AllowLogging))) {
					...
					if (extLogCount == _maxExtensionLogsPerRequest) {
						...
						int executionDuration = Convert.ToInt32(DateTime.Now.Subtract(startTime).TotalMilliseconds);
						ExtensionLog.StaticWrite(heContext.AppInfo, heContext.Session,
						instant, executionDuration, "RunJavaScript", errorLogId, 14, "HTTPRequestHandler");
						heContext.ExtensionLogCount = extLogCount + 1;
						RequestTracer reqTracer = heContext.RequestTracer;
						if (reqTracer != null) {
			...
			try {
				...
				(heContext.AppInfo.ExtensionProperties.AllowLogging("b1ef216b-d67f-454e-9f01-a7f0274608d6") && heContext.AppInfo.Properties.AllowLogging))) {
					...
					if (extLogCount == _maxExtensionLogsPerRequest) {
						...
						int executionDuration = Convert.ToInt32(DateTime.Now.Subtract(startTime).TotalMilliseconds);
						ExtensionLog.StaticWrite(heContext.AppInfo, heContext.Session,
						instant, executionDuration, "GetPageName", errorLogId, 14, "HTTPRequestHandler");
						heContext.ExtensionLogCount = extLogCount + 1;
						RequestTracer reqTracer = heContext.RequestTracer;
						if (reqTracer != null) {
