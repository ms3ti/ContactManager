...
namespace ssContactManager {
	...
	public sealed partial class ENContactEntity {
		...
		public static string ViewName(int? tenant, string locale) {
			return BaseAppUtils.EscapeAndQualifySqlIdentifier(DatabaseAccess.ForEspaceDatabase("794c445f-f27d-4f61-b47a-0da71440df68"), "OSUSR_dma_Contact");
		}
	} // ENContactEntity
	...
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("Contact", "8FoexHOwtk+ApPgBumSaRg", "X0RMeX3yYU+0eg2nFEDfaA", 0, "OSUSR_dma_Contact", null, false)]
	[Serializable()]
	public partial struct ENContactEntityRecord: ISerializable, ITypedRecord<ENContactEntityRecord>, ISimpleRecord {
		internal static readonly GlobalObjectKey IdId = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*A4XlnFcA2kyJFr7YYEZvCA");
		internal static readonly GlobalObjectKey IdName = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*D3LIKpL4pk+X6Uqde6qwJw");
		internal static readonly GlobalObjectKey IdJobTitle = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*nFuZfnS70EqlArXz4bdw1Q");
		internal static readonly GlobalObjectKey IdPhone = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*0JIwhmO3xEW7XXaWW8bB4w");
		internal static readonly GlobalObjectKey IdEmail = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*EIm9E+CvXU+wKr_OBdgxCg");
		internal static readonly GlobalObjectKey IdNotes = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*eLtGqeLN0kW7hQhHyDjf3g");
	...
	public partial struct RCContactRecord: ISerializable, ITypedRecord<RCContactRecord> {
		internal static readonly GlobalObjectKey IdContact = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*aza2YeSaqv1P7Ms5Z_9uqA");
