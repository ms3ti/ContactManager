...
namespace ssContactManager {
	...
	public sealed partial class ENMessageTypeEntity {
		...
		public static string ViewName(int? tenant, string locale) {
			return BaseAppUtils.EscapeAndQualifySqlIdentifier(DatabaseAccess.ForEspaceDatabase("794c445f-f27d-4f61-b47a-0da71440df68"), "OSUSR_dma_MessageType");
		}
	} // ENMessageTypeEntity
	...
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("MessageType", "VZ+cMg2nikak9YkQZoMoGw", "X0RMeX3yYU+0eg2nFEDfaA", 0, "OSUSR_dma_MessageType", null, false)]
	[Serializable()]
	public partial struct ENMessageTypeEntityRecord: ISerializable, ITypedRecord<ENMessageTypeEntityRecord>, ISimpleRecord {
		internal static readonly GlobalObjectKey IdId = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*c0xnIOJ1TkeIAS_qFYwvaw");
		internal static readonly GlobalObjectKey IdLabel = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*gaGRcQ+MYkK+jvpXCCup_Q");
	...
	partial class ENMessageTypeEntity: StaticEntityRuntime {
		...
		private static ENMessageTypeEntity instance = new ENMessageTypeEntity(125, ObjectKey.Parse("VZ+cMg2nikak9YkQZoMoGw"));
	...
	public partial struct RCMessageTypeRecord: ISerializable, ITypedRecord<RCMessageTypeRecord> {
		internal static readonly GlobalObjectKey IdMessageType = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*9rI2iC5mfK6nDPhSlTeWgQ");
