...
namespace ssContactManager {
	...
	public sealed partial class ENMenuItemEntity {
		...
		public static string ViewName(int? tenant, string locale) {
			return BaseAppUtils.EscapeAndQualifySqlIdentifier(DatabaseAccess.ForEspaceDatabase("794c445f-f27d-4f61-b47a-0da71440df68"), "OSUSR_dma_MenuItem");
		}
	} // ENMenuItemEntity
	...
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("MenuItem", "TrZcvI8wwEu7LdpnMR_pjQ", "X0RMeX3yYU+0eg2nFEDfaA", 0, "OSUSR_dma_MenuItem", null, false)]
	[Serializable()]
	public partial struct ENMenuItemEntityRecord: ISerializable, ITypedRecord<ENMenuItemEntityRecord>, ISimpleRecord {
		internal static readonly GlobalObjectKey IdId = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*qm3Bu7A1ZkKvg+uMetJxiw");
		internal static readonly GlobalObjectKey IdOrder = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*PXSBS310QUm2M4NqDVUTFw");
		internal static readonly GlobalObjectKey IdCaption = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*voDVP9bMx0qjODpU+_0Ccg");
	...
	partial class ENMenuItemEntity: StaticEntityRuntime {
		...
		private static ENMenuItemEntity instance = new ENMenuItemEntity(125, ObjectKey.Parse("TrZcvI8wwEu7LdpnMR_pjQ"));
	...
	public partial struct RCMenuItemRecord: ISerializable, ITypedRecord<RCMenuItemRecord> {
		internal static readonly GlobalObjectKey IdMenuItem = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*13MdcmHiiO+Kz0xPIZg+mQ");
