...
namespace ssContactManager {
	...
	public sealed partial class ENRecentItemEntity {
		...
		public static string ViewName(int? tenant, string locale) {
			return BaseAppUtils.EscapeAndQualifySqlIdentifier(DatabaseAccess.ForEspaceDatabase("794c445f-f27d-4f61-b47a-0da71440df68"), "OSUSR_dma_RecentItem");
		}
	} // ENRecentItemEntity
	...
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("RecentItem", "OttIDtYoMEebKFVmN4Hyxw", "X0RMeX3yYU+0eg2nFEDfaA", 0, "OSUSR_dma_RecentItem", null, false)]
	[Serializable()]
	public partial struct ENRecentItemEntityRecord: ISerializable, ITypedRecord<ENRecentItemEntityRecord>, ISimpleRecord {
		internal static readonly GlobalObjectKey IdId = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*Y+2exGUODUC5+aZAsn61sQ");
		internal static readonly GlobalObjectKey IdTenantId = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*Y5GEDs4xxkG_gT4WwUaIMQ");
		internal static readonly GlobalObjectKey IdUserId = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*md4PXuQ8SkKdequXz4PF7w");
		internal static readonly GlobalObjectKey IdLabel = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*iAEumvj0ekiZYdGgUbbl5w");
		internal static readonly GlobalObjectKey IdTag = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*rjNA8szH40u8CZ_sf2TViQ");
		internal static readonly GlobalObjectKey IdURL = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*_CrDvDrxSkqPOyZXhArsFg");
		internal static readonly GlobalObjectKey IdInstant = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*DL8zlpOWw0GdGatHyRu6kQ");
	...
	public partial struct RCRecentItemRecord: ISerializable, ITypedRecord<RCRecentItemRecord> {
		internal static readonly GlobalObjectKey IdRecentItem = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*yXq0WMBzVmD9rJ8tmZ1piw");
				...
				try {
					using(var insertSqlCmd = trans.CreateCommand(insertSql)) {
						if ((ssENRecentItem.ssTenantId==0)) {
							insertSqlCmd.CreateParameter("@ssTenantId", DbType.Int32, DBNull.Value);
						} else {
							insertSqlCmd.CreateParameter("@ssTenantId", DbType.Int32, ssENRecentItem.ssTenantId);
						}
						if ((ssENRecentItem.ssUserId==0)) {
							insertSqlCmd.CreateParameter("@ssUserId", DbType.Int32, DBNull.Value);
						} else {
		...
		public static void CreateOrUpdateRecentItem(HeContext heContext, BitArray usedFields, RCRecentItemRecord inParamSource, out int outParamId) {
			...
			using(Transaction trans = DatabaseAccess.ForCurrentDatabase.GetRequestTransaction()) {
				...
				using(var sqlCmd = trans.CreateCommand(sql)) {
					if (usedFields[1]) {
						if ((ssENRecentItem.ssTenantId==0)) {
							sqlCmd.CreateParameter("@ssTenantId", DbType.Int32, DBNull.Value);
						} else {
					...
					if (usedFields[2]) {
						if ((ssENRecentItem.ssUserId==0)) {
							sqlCmd.CreateParameter("@ssUserId", DbType.Int32, DBNull.Value);
						} else {
