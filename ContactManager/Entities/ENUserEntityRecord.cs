...
namespace ssContactManager {
	...
	public sealed partial class ENUserEntity {
		...
		public static string ViewName(int? tenant, string locale) {
			var tableOrViewName = tenant.HasValue ? string.Format("OSSYS_USER_T{0}", tenant): "OSSYS_USER";
			return BaseAppUtils.EscapeAndQualifySqlIdentifier(DatabaseAccess.ForEspaceDatabase("478870b9-2d60-4f73-9eb3-7cd8b994a737"), tableOrViewName);
		}
	...
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("User", "LYIWpF+Ey0aicHD144NUTA", "uXCIR2Atc0+es3zYuZSnNw", 0, "OSSYS_USER", "", false)]
	[Serializable()]
	public partial struct ENUserEntityRecord: ISerializable, ITypedRecord<ENUserEntityRecord>, ISimpleRecord {
		internal static readonly GlobalObjectKey IdTenant_Id = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*LYIWpF+Ey0aicHD144NUTA.#Tenant_Id");
		...
		internal static readonly GlobalObjectKey IdUsername = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*mugM0ElVgUaEErmgAetI8Q");
		internal static readonly GlobalObjectKey IdPassword = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*_cxpuWFpPUi4H+A7HaxJQg");
		internal static readonly GlobalObjectKey IdEmail = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*kGAqP0RQmkSYTElnszcN7Q");
		internal static readonly GlobalObjectKey IdMobilePhone = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*qL8ukzbp2kGJZ0lzLV5McQ");
		internal static readonly GlobalObjectKey IdExternal_Id = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*z8MVwsFKV0Ks044qtUfOoA");
		internal static readonly GlobalObjectKey IdCreation_Date = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*WY4uSycpREGJnU3kpRyg6A");
		internal static readonly GlobalObjectKey IdLast_Login = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*UBODk8iNSEqOlVG0rOue_A");
		internal static readonly GlobalObjectKey IdIs_Active = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*dWrsyaXEJUC80yx4s4VqjQ");
