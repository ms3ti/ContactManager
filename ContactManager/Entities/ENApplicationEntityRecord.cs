...
namespace ssContactManager {
	...
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("Application", "LugdRG2bMU6IqEyawuIOLQ", "uXCIR2Atc0+es3zYuZSnNw", 0, "OSSYS_APPLICATION", "", false)]
	[Serializable()]
	public partial struct ENApplicationEntityRecord: ISerializable, ITypedRecord<ENApplicationEntityRecord>, ISimpleRecord {
		internal static readonly GlobalObjectKey IdId = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*H0sDotYl70GGfOx8lRM_ug");
		internal static readonly GlobalObjectKey IdName = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*PGQh5tFlAES_4kli11PhvA");
		internal static readonly GlobalObjectKey IdDescription = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*hgknbdpocEyrhUN3vZIPIw");
		internal static readonly GlobalObjectKey IdEntry_eSpace_Id = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*C8aobVR_oUuMiwEHwXZWMA");
		internal static readonly GlobalObjectKey IdBackOffice_eSpace_Id = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*QCOme+VHd0+lD7yaJaZIyA");
		internal static readonly GlobalObjectKey IdDefaultThemeIsMobile = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*S9Y8Od3t_U+9evFgPosG0Q");
		internal static readonly GlobalObjectKey IdKey = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*8YD6Rai0VECiY4hVXcisag");
		internal static readonly GlobalObjectKey IdIs_Active = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*WeELtUIsZU24Q055np7Bfw");
		internal static readonly GlobalObjectKey IdDisabled = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*Ko02D6F5JUaDrRoGyBdYMw");
		internal static readonly GlobalObjectKey IdCreatedBy = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*Bkpgv6v2V0iZF3O0owQ8zg");
		internal static readonly GlobalObjectKey IdApplicationKind = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*sp2G8EIIb0KmpfnbKe6Ylg");
		internal static readonly GlobalObjectKey IdTemplateKey = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*VM4z9Yp7iUGbwXeMmGYpTQ");
		internal static readonly GlobalObjectKey IdPrimaryColor = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*MlDLMt4PO0WWCrtMYXQaag");
		internal static readonly GlobalObjectKey IdNativeHash = GlobalObjectKey.Parse("uXCIR2Atc0+es3zYuZSnNw*rb5hIta3FEKlLwnpMjHeIw");
	...
	public partial struct RCApplicationRecord: ISerializable, ITypedRecord<RCApplicationRecord> {
		internal static readonly GlobalObjectKey IdApplication = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*6c_4gug9Adz4EzNckK0HSA");
		...
		public static void GetApplication(HeContext heContext, int inParamId, out RCApplicationRecord outParamRecord) {
			...
			try {
				...
				using(Transaction trans = DatabaseAccess.ForCurrentDatabase.GetRequestTransaction()) {
					...
					} catch (System.Exception queryExcept) {
						throw new DataBaseException("Error executing query.", queryExcept);
					}
				}
			} finally {
