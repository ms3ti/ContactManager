	...
	public class JSONENUserEntityRecord: AbstractRESTStructure<ENUserEntityRecord> {
		...
		public JSONENUserEntityRecord(ENUserEntityRecord s, IBehaviorsConfiguration config) {
			if (config.DefaultValuesBehavior == DefaultValuesBehavior.DontSend) {
				...
				AttrCreation_Date = OutSystems.RESTService.Runtime.Abstractions.Conversions.DateTimeToRestType(s.ssCreation_Date, config.DateTimeFormat);
				...
				AttrCreation_Date = OutSystems.RESTService.Runtime.Abstractions.Conversions.DateTimeToRestType(s.ssCreation_Date, config.DateTimeFormat);
				AttrLast_Login = OutSystems.RESTService.Runtime.Abstractions.Conversions.DateTimeToRestType(s.ssLast_Login, config.DateTimeFormat);
				AttrIs_Active = (bool?) s.ssIs_Active;
			}
		}
		...
		public static ENUserEntityRecord ToStructure(ssContactManager.RestRecords.JSONENUserEntityRecord obj, IBehaviorsConfiguration config) {
			...
			if (obj != null) {
				...
				s.ssCreation_Date = obj.AttrCreation_Date == null ? new DateTime(1900, 1, 1, 0, 0, 0): OutSystems.RESTService.Runtime.Abstractions.Conversions.TextToDateTime(obj.AttrCreation_Date, config.DateTimeFormat);
				s.ssLast_Login = obj.AttrLast_Login == null ? new DateTime(1900, 1, 1, 0, 0, 0): OutSystems.RESTService.Runtime.Abstractions.Conversions.TextToDateTime(obj.AttrLast_Login, config.DateTimeFormat);
