...
namespace ssContactManager {
	...
	public partial struct STFeedback_MessageStructure: ISerializable, ITypedRecord<STFeedback_MessageStructure>, ISimpleRecord {
		internal static readonly GlobalObjectKey IdMessageText = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*O6IcIP3qJEWFkpggfvtpiw");
		internal static readonly GlobalObjectKey IdMessageType = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*iAChiHt8HkiyPsQ1aK+Lug");
	...
	public partial struct RCFeedback_MessageRecord: ISerializable, ITypedRecord<RCFeedback_MessageRecord> {
		internal static readonly GlobalObjectKey IdFeedback_Message = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*el4mp+VMhhTgVzRxv3bpDQ");
