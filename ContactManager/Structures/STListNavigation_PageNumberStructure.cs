...
namespace ssContactManager {
	...
	public partial struct STListNavigation_PageNumberStructure: ISerializable, ITypedRecord<STListNavigation_PageNumberStructure>, ISimpleRecord {
		internal static readonly GlobalObjectKey IdNumber = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*HKOxNf7SH0ysJ81Yw0xkmQ");
		internal static readonly GlobalObjectKey IdIndex = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*FzwQqslR3ECTfXmBdq6JbQ");
		internal static readonly GlobalObjectKey IdIsCurrent = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*dGIHB8YO00OTdqLdxhy25g");
	...
	public partial struct RCListNavigation_PageNumberRecord: ISerializable, ITypedRecord<RCListNavigation_PageNumberRecord> {
		internal static readonly GlobalObjectKey IdListNavigation_PageNumber = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*1k5UtbxAhdvRLfo0gXQdDw");
