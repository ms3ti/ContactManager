...
namespace ssContactManager {
	...
	public partial struct STExcel_ContactsStructure: ISerializable, ITypedRecord<STExcel_ContactsStructure>, ISimpleRecord {
		internal static readonly GlobalObjectKey IdName = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*zCiUgsUvxU2OwJkO95JpOw");
		internal static readonly GlobalObjectKey IdJobTitle = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*+dUKzCy8wEuj6PJHd3dy+g");
		internal static readonly GlobalObjectKey IdPhone = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*UZFtWPuVYU+5pgK9txt6hw");
		internal static readonly GlobalObjectKey IdEmail = GlobalObjectKey.Parse("X0RMeX3yYU+0eg2nFEDfaA*yLAOIsxeoU6xt7H2HuuZZw");
	...
	public partial struct RCExcel_ContactsRecord: ISerializable, ITypedRecord<RCExcel_ContactsRecord> {
		internal static readonly GlobalObjectKey IdExcel_Contacts = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*6XRh7Abk6qnvR0iT6tENWg");
