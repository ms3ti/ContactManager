	...
	public class ScrnInvalidPermissions: OSPageViewStateCompressed, IWebScreen, INegotiateTabIndexes, IBookmarkableURL {
		...
		protected void InitializeUrls() {
			...
			if (Request.AppRelativeCurrentExecutionFilePath.IndexOf('/', 2) == -1) {
				...
				actionUrl += AppUtils.GetPageName(heContext, AppUtils.eSpaceId, "InvalidPermissions", parameters,/*useParamsOnlyIfNeededForRule*/ true);
			}
			bookmarkableUrl += AppUtils.GetPageName(heContext, AppUtils.eSpaceId, "InvalidPermissions", parameters,/*useParamsOnlyIfNeededForRule*/ false);
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			if (!IsPostBack) {
				ArrayList screenParameters = (ArrayList) AppUtils.App.OsContext.Session["ContactManager._ScreenParameters_InvalidPermissions"];
				...
				if ((screenParametersKey == null || this.Key.Equals(ObjectKey.Parse(Convert.ToString(screenParametersKey)))) && screenParameters != null) {
					try {
						...
						AppUtils.App.OsContext.Session["ContactManager._ScreenParameters_InvalidPermissions"] = null;
