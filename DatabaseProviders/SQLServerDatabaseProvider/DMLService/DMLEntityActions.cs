...
namespace OutSystems.HubEdition.DatabaseProvider.SqlServer.DMLService {
    public class DMLEntityActions : BaseDMLEntityActions {
        ...
        private DatabaseInfo DatabaseInfo {
            get {
                return TableSourceInfo?.Database;
            }
        }
        ...
        public override string GetInlineTableName(EntityActionKind action) {
            if (UseInlineBehavior(action)) {
                string catalog = DMLService.Identifiers.EscapeIdentifier(DatabaseInfo.Catalog);
                string schema = DMLService.Identifiers.EscapeIdentifier(TableSourceInfo.Schema);
                string tableSource = DMLService.Identifiers.EscapeIdentifier(TableSourceInfo.Name);
                
                return $"{catalog}.{schema}.{tableSource}";
            }
        ...
        public override IDictionary<InsertPlaceholder, string> SQLPlaceholderValuesForCreateAndRetrieveId(string idColumnName, 
                                                                                                          string outputParameterName, 
                                                                                                          out RetrieveIdMethod retrieveIdMethod) {
                    ...
                    lock (this) {
                        if (updatePlaceholderValuesLinkedTable == null) {
                            updatePlaceholderValuesLinkedTable = new Dictionary<UpdatePlaceholder, string> {
                                {UpdatePlaceholder.BeforeStatement, "SET NOCOUNT OFF; SET XACT_ABORT ON;"},
                                {UpdatePlaceholder.AfterStatement, "; SET XACT_ABORT OFF;"}
                            };
                        }
                    }
                }
                ...
                lock (this) {
                    if (updatePlaceholderValues == null) {
                        updatePlaceholderValues =
                            new Dictionary<UpdatePlaceholder, string> {{UpdatePlaceholder.BeforeStatement, "SET NOCOUNT OFF;"}};
                    }
                }
            }
                    ...
                    lock (this) {
                        if (deletePlaceholderValues == null) {
                            deletePlaceholderValues = new Dictionary<DeletePlaceholder, string> {
                                {DeletePlaceholder.BeforeStatement, "SET XACT_ABORT ON;"},
                                {DeletePlaceholder.AfterStatement, "; SET XACT_ABORT OFF;"}
                            };
                        }
                    }
                }
