...
using OutSystems.HubEdition.DatabaseAbstractionLayer.Platform;
...
using OutSystems.HubEdition.DatabaseProvider.SqlServer.Platform.DMLService;
using OutSystems.HubEdition.DatabaseProvider.SqlServer.Platform.ExecutionService;
using OutSystems.HubEdition.DatabaseProvider.SqlServer.Platform.IntrospectionService;
using OutSystems.HubEdition.DatabaseProvider.SqlServer.Platform.Session;
...
namespace OutSystems.HubEdition.DatabaseProvider.SqlServer.Platform {
    internal class PlatformDatabaseServices : DatabaseServices, IPlatformDatabaseServices {
        ...
        public IDDLService DDLService { get; }
        public IPlatformSessionService SessionService { get; }
        ...
        public PlatformDatabaseServices(IRuntimeDatabaseConfiguration databaseConfiguration) : base(databaseConfiguration) {
            ...
            executionService = new PlatformExecutionService(this);
            dmlService = new PlatformDMLService(this);
            introspectionService = new PlatformIntrospectionService(this);
            DDLService = new DDLService.DDLService(this);
            if (databaseConfiguration is RuntimeDatabaseConfiguration conf && conf.UseInMemorySession) {
                SessionService = InMemoryPlatformSessionLoader.Instance
                    .GetNewInMemoryPlatformSessionService(conf.InMemorySessionProvider, this, conf.InMemorySessionConnectionString);
            } else {
                SessionService = new PlatformSessionService(this);
            }
        }
