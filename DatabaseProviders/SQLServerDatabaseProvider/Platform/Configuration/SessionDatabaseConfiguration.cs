...
namespace OutSystems.HubEdition.DatabaseProvider.SqlServer.Platform.Configuration {
    public class SessionDatabaseConfiguration : AbstractSessionDatabaseConfiguration, IElevatedUserConfiguration {
        ...
        [UserDefinedConfigurationParameter(Label = "Server", IsMandatory = true, Order = 1,
            Region = ParameterRegion.SessionDatabaseLocation)]
        ...
        [UserDefinedConfigurationParameter(Label = "Database", IsMandatory = true, Order = 2,
            Region = ParameterRegion.SessionDatabaseLocation)]
        ...
        public IRuntimeDatabaseConfiguration ElevatedRuntimeDatabaseConfiguration() {
            return new RuntimeDatabaseConfiguration(PlatformDatabaseProvider) {
                ConnectionString = ConnectionStringHelper.Build(
                    ElevatedAuthenticationCredential,
