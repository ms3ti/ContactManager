...
namespace OutSystems.HubEdition.DatabaseProvider.SqlServer.Platform.Configuration {
    ...
    public class LoggingDatabaseConfiguration : BaseSettableTwoUserDatabaseConfiguration {
        ...
        public override string DefaultAdminUser => "OSADMIN_LOG";

        public override string DefaultRuntimeUser => "OSRUNTIME_LOG";

        public override string DefaultCatalog => "outsystems_log";
    }
}
