...
namespace OutSystems.HubEdition.DatabaseProvider.SqlServer.Platform.DatabaseObjects {
    public class PlatformTableSourceColumnInfo : TableSourceColumnInfo, IPlatformTableSourceColumnInfo {
        public PlatformTableSourceColumnInfo(ITableSourceInfo tableSource, string name, IPlatformDataTypeInfo dataType,
                                             bool isMandatory, bool isPrimaryKey, bool isAutoGenerated)
            : base(tableSource, name, dataType, isMandatory, isPrimaryKey, isAutoGenerated) { }
