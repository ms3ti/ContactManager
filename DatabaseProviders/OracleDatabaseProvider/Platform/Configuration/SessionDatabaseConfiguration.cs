...
namespace OutSystems.HubEdition.DatabaseProvider.Oracle.Platform.Configuration {
    ...
    public sealed class SessionDatabaseConfiguration : AbstractSessionDatabaseConfiguration {
        ...
        private const string DEFAULT_NLS_SORT = "BINARY"; //For performance reasons, session database does not use case dependent nls_sorts
        ...
        public override IRuntimeDatabaseConfiguration RuntimeDatabaseConfiguration() {
            return new RuntimeDatabaseConfiguration(PlatformDatabaseProvider) {
                ...
                UseInMemorySession = UseInMemorySession,
                InMemorySessionProvider = InMemorySessionProvider,
                InMemorySessionConnectionString = InMemorySessionConnectionString
            };
        }
        ...
        private string ConnectionString() {
            return ConnectionStringHelper.Build(SessionAuthenticationCredential, Host, Port,
                ServiceName, TNSName, IsServiceName(), SessionAdvancedSettings);
        }
        #endregion
...
The TNS configuration file (/etc/outsystems/tnsnames.ora) should be changed to include the chosen TNS name.";
        ...
        [UserDefinedConfigurationParameter(Label = "Error Messages Language", IsMandatory = false, Order = 3, Region = ParameterRegion.AdvancedSession, Prompt = "Error messages language", Example = "This overrides the value of the NLS_LANGUAGE parameter.")]        
