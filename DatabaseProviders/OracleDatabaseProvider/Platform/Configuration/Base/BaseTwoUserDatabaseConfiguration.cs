...
namespace OutSystems.HubEdition.DatabaseProvider.Oracle.Platform.Configuration {
    ...
    public abstract class BaseTwoUserDatabaseConfiguration : AbstractTwoUserDatabaseConfiguration {
        ...
        public BaseTwoUserDatabaseConfiguration() {
        ...
        private const string IndexTablespacePrefix = "OSIDX_";
        private const string AdminTablespacePrefix = "OSSYS_";
        private const string AdminUserPrefix = "OSADMIN_";
        private const string RuntimeUserPrefix = "OSRUNTIME_";

        private string ConnectionString(NetworkCredential userCredentials) {
            return ConnectionStringHelper.Build(userCredentials, Host, Port,
                ServiceName, TNSName, IsServiceName(), RuntimeAdvancedSettings);
        }
        #endregion
        ...
        [UserDefinedConfigurationParameter(Label = "TNS Name", VisibilityChecker = "IsTNSName", ExistsIf = "NamingType.TNS_Name", IsMandatory = true, Order = 1, Region = ParameterRegion.DatabaseLocation, Prompt = "TNS Name")]
        public string TNSName { get; set; }

        [UserDefinedConfigurationParameter(Label = "Host", VisibilityChecker = "IsServiceName", ExistsIf = "NamingType.Service_Name", IsMandatory = true, Order = 1, Region = ParameterRegion.DatabaseLocation, Prompt = "Host")]
        public string Host { get; set; }

        [UserDefinedConfigurationParameter(Label = "Port", VisibilityChecker = "IsServiceName", ExistsIf = "NamingType.Service_Name", IsMandatory = true, Order = 2, Region = ParameterRegion.DatabaseLocation, Prompt = "Port")]
        public int Port { get; set; }

        [UserDefinedConfigurationParameter(Label = "Service Name", VisibilityChecker = "IsServiceName", ExistsIf = "NamingType.Service_Name", IsMandatory = true, Order = 3, Region = ParameterRegion.DatabaseLocation, Prompt = "Service Name")]
        ...
        public string AdminTablespace {
            get {
                return adminTablespace ?? AdminTablespacePrefix + ConfigurationSufix;
            }
            set {
        ...
        public string IndexTablespace {
            get {
                return indexTablespace ?? IndexTablespacePrefix + ConfigurationSufix;
            }
            set {
        ...
        public override string DefaultAdminUser => AdminUserPrefix + ConfigurationSufix;
        ...
        public override string DefaultRuntimeUser => RuntimeUserPrefix + ConfigurationSufix;
...
Change the TNS configuration file at '/etc/outsystems/tnsnames.ora' to include the chosen TNS name.";
        ...
        public override bool Equals(ITwoUserDatabaseConfiguration obj) {
            ...
            var other = (BaseTwoUserDatabaseConfiguration)obj;
