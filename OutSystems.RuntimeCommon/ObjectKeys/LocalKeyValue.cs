...
namespace OutSystems.ObjectKeys {
    ...
    // !!! Please ensure that you add new values to the end !!!
    // Changing this enum requires all consumers to be recompiled against
    // the new version, in order for them to not see different values.
    public enum LocalKeyValue : ushort {
        ...
        DatabaseViews,
        ReferenceDatabaseViews,

        // Screen Data Source dependencies
        ViewDataDependencies,
        ...
        // EspaceConfiguration Expression
        Expression,

        // Events
        GlobalEvents,
        ReferenceGlobalEvents,
        GlobalEventHandlers,
        OnCreate,
        OnUpdate,
        OnDelete,
        ...
        OpenOnConditions,
        ReleaseOnConditions,
        ReassignOnConditions,
        CloseOnConditions,
        ActivityData,

        RequiredModelPlugins,
        WidgetDefinitions,
        ReferenceWidgetDefinitions,
        WidgetProperties,
    }
}