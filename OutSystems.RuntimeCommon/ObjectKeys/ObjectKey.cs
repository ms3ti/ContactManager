...
namespace OutSystems.ObjectKeys {
    ...
    public abstract partial class ObjectKey : IComparable, IComparable<ObjectKey>, ISerializable {
        ...
        /// <returns></returns>
        [Obsolete("Use ObjectKey.Parse() instead.")]
...
//#if !SERVICESTUDIO
//        [Obsolete("Not all ObjectKeys are Guids! Use .DatabaseValue or ObjectKeyUtils.DatabaseValue() for string serialization purposes.")]
//#endif
