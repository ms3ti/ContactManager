...
namespace OutSystems.RuntimeCommon {
	...
	public class HEMessage: IMessageObject {
        ...
        bool IMessageObject.Submitable => Submitable;
	...
	public class HEMessageArrayList : ArrayList {
		...
		public int Add(HEMessage val) {
            if (val == null) {
                throw new ArgumentNullException(nameof(val), "Cannot add a null value to HEMessageArrayList");
            }
            if (isReadOnly) {
        ...
        public void AddRange(HEMessageArrayList messages) {
            foreach (HEMessage message in messages) {
                Add(message);
            }
        }
        ...
        public IEnumerable<HEMessage> Where(Func<HEMessage, bool> predicate) {
	...
	public class HEMessageException : Exception 
	{
        ...
        public HEMessageException(HEMessage message, Exception innerException, bool supressStack, bool startWithInnerException)
            : this(message, innerException, 1, supressStack, startWithInnerException) {
        }
