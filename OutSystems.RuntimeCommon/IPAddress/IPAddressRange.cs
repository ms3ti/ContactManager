    ...
    public class IPAddressRange : IEnumerable<IPAddress> {
        ...
        public IPAddressRange(IPAddress begin, IPAddress end) {
            ...
            if (!Bits.LE(endBytes, beginBytes)) {
                throw new ArgumentException("Begin must be smaller than the End", "beginEnd");
            }
        }
        ...
        public bool Contains(IPAddress ipaddress) {
            if (!IsInSameAddressFamily(ipaddress, this.Begin)) {
                return false;
            }
        ...
        public static bool IsInSameAddressFamily(IPAddress firstAddress, IPAddress secondAddress) {
            return (IPAddressUtils.IPAddressIsValidIPv4(firstAddress.ToString()) && IPAddressUtils.IPAddressIsValidIPv4(secondAddress.ToString()))
            || (IPAddressUtils.IPAddressIsValidIPv6(firstAddress.ToString()) && IPAddressUtils.IPAddressIsValidIPv6(secondAddress.ToString()));
        }
        ...
        public static int SubnetMaskLength(IPAddress subnetMask) {
            ...
            if (length == null) throw new ArgumentException("Not a valid subnet mask", nameof(subnetMask));
            return length.Value;
        }
