...
namespace OutSystems.RuntimeCommon {
    ...
    public class MessageDefinition {
        ...
        public readonly string InContextDetail;
        public readonly string ModelFeature;
        ...
        public MessageDefinition(string id, MessageType type, string message, string detail, string modelFeature, string description, string footer, string extraInfo, int helpRef, bool submitable, Button[] buttons, ButtonType defaultButton, ButtonType cancelButton, bool requiresLUV = false, string inContextDetail = null) {
            Id = id;
            Type = type;
            ...
            InContextDetail = inContextDetail.IsNullOrEmpty() ? Detail : inContextDetail;
        }
        ...
        public override string ToString() {
            ...
            if (!string.IsNullOrEmpty(ModelFeature)) {
                result += "ModelFeature: " + ModelFeature + Environment.NewLine;
            }
        ...
        private MessageDefinition(MessageId messageId, params string[] args) {
            ...
            try {
                ...
                var inContextDetail = Detail;
                if (parts.Length > 12) {
                    inContextDetail = parts[12];
                }
                InContextDetail = inContextDetail;
        ...
        public override bool Equals(object obj) {
            ...
            return Id == message.Id &&
                   ...
                   ModelFeature == message.ModelFeature &&
