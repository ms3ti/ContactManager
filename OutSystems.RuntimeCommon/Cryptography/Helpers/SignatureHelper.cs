...
namespace OutSystems.RuntimeCommon.Cryptography
{
    ...
    public static class SignatureHelper
    {
        ...
        /// <summary>
        /// Signs the plain text with Hash-based Message Authentication Code (HMAC) using the <see cref="T:System.Security.Cryptography.HMACSHA256"/>.
        /// </summary>
        /// <param name="plainText">The plain text.</param>
        /// <param name="key"></param>
        /// <returns>The signed(hashed) text in Base64.</returns>
        public static string SignSHA256(string plainText, string key) {
            return CryptManager.Instance.SignSHA256(plainText, key);
        }
