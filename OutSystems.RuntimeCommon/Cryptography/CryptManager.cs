...
namespace OutSystems.RuntimeCommon.Cryptography {
    ...
    public class CryptManager {
        ...
        private static byte[] HashToBytes(Stream inputStream, IHashGenerator hashGenerator) {
            return hashGenerator.Hash(inputStream);
        }
        ...
        internal byte[] HashSHA512ToBytes(Stream inputStream) {
            return HashToBytes(inputStream, hashSHA512Generator);
        }
        ...
        internal string SignSHA256(string plainText, string key) {
            return SignSHA256(Encode(plainText), Encode(key));
        }
        ...
        private string SignSHA256(byte[] bytes, byte[] key) {
            return EncodeBase64(ByteSignHMACSHA256(bytes, key));
        }
