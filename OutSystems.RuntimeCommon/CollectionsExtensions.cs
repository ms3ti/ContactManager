...
namespace OutSystems.RuntimeCommon {
    ...
    public static partial class CollectionsExtensions {
        ...
        public static ConcurrentDictionary<TKey, TValue> ToConcurrentDictionary<TKey, TValue>(this IEnumerable<TValue> source, Func<TValue, TKey> keySelector) {
            var converter = source.Select(sourceValue => new KeyValuePair<TKey, TValue>(keySelector(sourceValue), sourceValue));
            return new ConcurrentDictionary<TKey, TValue>(converter);
        }
        ...
        [DebuggerNonUserCode]
        public static HashSet<T> LegacyToHashSet<T>(this IEnumerable<T> fromEnumerable) {
