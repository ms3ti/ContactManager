...
#if !NETSTANDARD // TODO RRCT-2735 , currently no automatic image rotation in Asp.Net Core apps
using System;
using System.Text;
...
namespace OutSystems.Application.EXIFExtractor {
    /// <summary>
    /// EXIFextractor Class
    ///
    /// </summary>
    public class EXIFextractor : IEnumerable {
        ...
        private static PropertyItem CreatePropertyItem(short type, int tag, int len, byte[] value) {
            ...
            Stream emptyBitmapStream = assembly.GetManifestResourceStream(assembly.GetName().Name + ".EXIFExtractor.decoy.jpg");
        ...
        private void buildDB(System.Drawing.Imaging.PropertyItem[] parr) {
            ...
            foreach (System.Drawing.Imaging.PropertyItem p in parr) {
                ...
                if (p.Type == 0x1) {
                    v = p.Value != null? p.Value[0].ToString() : string.Empty;
                }
