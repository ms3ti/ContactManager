    ...
    public class RequestTracer {
        ...
        public string ClientIP {
            get {
                ...
                return (info == null) ? "" : RuntimePlatformUtils.GetRequestRealIP(info.OsContext.CurrentHttpContext.Request);
            }
        }
        ...
        public RequestTracer(AppInfo appInfo)
            : this(
                appInfo.ApplicationUID,
                appInfo.ApplicationName,
                appInfo.eSpaceUID,
                appInfo.eSpaceName,
                appInfo.Tenant.Id_Guid,
                appInfo.Tenant.Name,
                appInfo.EnvironmentKey,
                appInfo.EnvironmentName,
                appInfo.FrontendName) {
        }
