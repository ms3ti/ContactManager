...
namespace OutSystems.HubEdition.RuntimePlatform.Callbacks {
    ...
    public sealed class CallbackResultStorage {
        ...
        public object Retrieve(int callbackId, string locale) {
            if (!_storageByLocale.TryGetValue(locale, out IDictionary<int, object> inLocale)) {
                return null;
            }

            if (!inLocale.TryGetValue(callbackId, out object obj)) {
                return null;
            }
            return obj;
        }
        ...
        public object RetrieveSingleton(int callbackId) {
            if (!_singletonStorage.TryGetValue(callbackId, out object obj)) {
                return null;
            }
            return obj;
        }
