...
namespace OutSystems.HubEdition.RuntimePlatform {
    [HubEdition.Extensibility.Data.Platform.QueryProvider.DatabaseProviderSpecificImplementationFor("Oracle")]
    ...
    internal class DBRuntimePlatformOracle : DBRuntimePlatform {
        ...
        public override string GetSelectForValues(IEnumerable<int> ids, string idColumnName) {
            ...
            return $@"SELECT column_value as {idColumnName}
                        FROM 
                        (
                            table(sys.odcinumberlist({idsValues}))
                        ) SOME_NAME";
        }
        #endregion
