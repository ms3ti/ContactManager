...
namespace OutSystems.RuntimePublic.Db {
    ...
    public sealed class DataParameter {
        ...
        private readonly Internal.Db.DataParameter parameter;

        internal DataParameter(Internal.Db.DataParameter parameter) {
            this.parameter = parameter ?? throw new ArgumentNullException(nameof(parameter), "Parameter cannot be initialized with null.");
        }
