...
namespace OutSystems.RuntimePublic.Db {
    ...
    public sealed class Connection : IDisposable {
        ...
        private readonly Internal.Db.DatabaseConnection connection;

        internal Connection(Internal.Db.DatabaseConnection connection) {
            this.connection = connection ?? throw new ArgumentNullException(nameof(connection), "Connection cannot be initialized with null.");
        }
