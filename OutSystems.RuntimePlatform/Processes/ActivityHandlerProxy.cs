...
namespace OutSystems.HubEdition.RuntimePlatform.Processes {
	...
	public class ActivityHandler : SoapHttpClientProtocol, IActivitiesClient {
        ...
        TimeSpan IActivitiesClient.Timeout {
            get => TimeSpan.FromMilliseconds(base.Timeout);
            set => base.Timeout = (int)value.TotalMilliseconds;
        }
        ...
        public bool ExecuteActivityAction(string ssKey, int activityId, int processId, int tenantId, ActivityStatus forInitialStatus, DateTime previousNextRun) {
            return ExecuteActivityActionv2(ssKey, activityId, processId, tenantId, forInitialStatus, previousNextRun);
        }
