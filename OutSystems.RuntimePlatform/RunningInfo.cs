...
namespace OutSystems.HubEdition.RuntimePlatform {
    ...
    public class RunningInfo {
        ...
        [Obsolete("Please use ManifestVersionToken")]
        public static string ESpaceVersionToken {
            get {
                return ManifestVersionToken;
            }
            set {
                ManifestVersionToken = value;
            }
        }

        public static string ManifestVersionToken { get; set; }
        ...
        public static void InitializeRunningInfo() {
            ...
            lock (typeof(RunningInfo)) {
                ...
                try {
                    ...
                    initialized = false;
                    InitializingErrorMessage = $"An exception occurred during RunningInfo initialization: {e.Message}";
