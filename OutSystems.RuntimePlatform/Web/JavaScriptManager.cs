...
namespace OutSystems.HubEdition.RuntimePlatform.Web
{
	...
	public class JavaScriptManager {
        ...
        private static string HttpItemOSRelativeJSPrefix = "OSRelativeJSPrefix";
...
";
		...
		public static string GetRelativeJavaScriptPrefix() => HttpService.Context.Items.GetValueOrDefault(HttpItemOSRelativeJSPrefix, "");
		...
		public static void CheckRelativeJavaScriptPrefix(string applicationPath) {
            ...
            HttpService.Context.Items[HttpItemOSRelativeJSPrefix] = relativePath;
        }
