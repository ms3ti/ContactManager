...
namespace OutSystems.HubEdition.RuntimePlatform {
    ...
    public class OsISAPIFilter {
        ...
        public bool IsActiveInRequest(IHttpRequest request) {
            return IsEnabled && request.Headers[OSOriginalHostHeader] != null;
        }

        public string GetHost(IHttpRequest request, string defaultValue = null) {
        ...
        public string GetHostSuffix(IHttpRequest request, string defaultValue = null) {
            if (IsActiveInRequest(request)) {
        ...
        public string GetPath(IHttpRequest request, string defaultValue = null) {
            if (IsActiveInRequest(request)) {
        ...
        public string GetPTA(IHttpRequest request, string defaultValue = null) {
            if (IsActiveInRequest(request)) {
        ...
        public string GetPage(IHttpRequest request, string defaultValue = null) {
            if (IsActiveInRequest(request)) {
        ...
        public string GetLocale(IHttpRequest request) {
            return GetCustomHeader(request, OSLocaleHeader);
        }

        public string GetCustomHeader(IHttpRequest request, string name) {
            if (IsActiveInRequest(request)) {
