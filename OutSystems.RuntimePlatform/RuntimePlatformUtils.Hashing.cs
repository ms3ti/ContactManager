        ...
        public static class Hashing {
            ...
            public class MD5Hash: SingletonVersionedCryptographyAlgorithm<MD5Hash>, IHash {
                bool IHash.CheckHash(string password, string hash) {
                    bool forceSecureAlgorithms = RuntimePlatformSettings.Authentication.ForceSecureAlgorithmsInAuthentication.GetValue();

                    if (forceSecureAlgorithms) {
                ...
                protected override string InnerApplyAlgorithm(string password) {
                    var hash = MD5PasswordHelper.HexDeriveUsingUTF16(password, SharedKeys.PrivateSalt());
                    OSTrace.Debug("MD5HashWithPrivateSalt returned:" + hash);
                    return hash;
                }
            }
