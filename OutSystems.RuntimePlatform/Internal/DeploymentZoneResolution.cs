...
namespace OutSystems.HubEdition.RuntimePlatform.Internal {
    ...
    public class DeploymentZoneResolution {
        ...
        private const string ZONE_CACHE_BY_KEY_PREFIX = "DeploymentZoneResolution_ZoneByKey_";
        private const string MODULE_KEY_CACHE_BY_NAME_PREFIX = "DeploymentZoneResolution_ModulekeyByName_";
