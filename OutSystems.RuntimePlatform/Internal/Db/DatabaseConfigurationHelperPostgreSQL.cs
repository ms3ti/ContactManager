...
namespace OutSystems.Internal.Db {
    ...
    internal class DatabaseConfigurationHelperPostgreSQL : DatabaseConfigurationHelper {
        internal override IRuntimeDatabaseConfiguration ChangeConnectionString(IIntegrationDatabaseConfiguration configuration, string connectionString,
            ...
            config.SetParameter("Schema", databaseIdentifier, SecureConfidentialInformationEncryption.TryDecryptString);
            return config;
        }
    }
}
