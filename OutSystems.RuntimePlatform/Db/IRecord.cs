...
namespace OutSystems.HubEdition.RuntimePlatform.Db
{
    ...
    public abstract class ReferenceStructureAdapter<T> : IRecord {
        public T Record;

        public BitArray[] AllOptimizedAttributes { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }

        public abstract object AttributeGet(GlobalObjectKey key);
        public abstract void FillFromOther(IRecord other);
        ...
        public void ReadDB(IDataReader reader) {
            throw new NotImplementedException();
        }
