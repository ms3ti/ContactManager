...
namespace OutSystems.HubEdition.RuntimePlatform.Log {
    ...
    public class RequestEvent {
        ...
        public RequestEvent(DateTime Instant, string RequestKey, string RequestEventName, string ModuleKey, string ModuleName, string ApplicationKey, string ApplicationName, string EventDetails) {
            log = new RequestEventDefinition(Instant, RequestKey, RequestEventName, ModuleKey, ModuleName, ApplicationKey, ApplicationName, EventDetails, accessVisibility: LogAccessHelper.GetAccessVisibility(ObjectKey.Parse(ApplicationKey)));
        }
        ...
        public static void StaticWrite(DateTime Instant, string RequestKey, string RequestEventName, string ModuleKey, string ModuleName, string ApplicationKey, string ApplicationName, string EventDetails) {
            RequestEventDefinition.StaticWrite(Instant, RequestKey, RequestEventName, ModuleKey, ModuleName, ApplicationKey, ApplicationName, EventDetails, accessVisibility: LogAccessHelper.GetAccessVisibility(ObjectKey.Parse(ApplicationKey)));
        }
