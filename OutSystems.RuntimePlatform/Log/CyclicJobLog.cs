...
namespace OutSystems.HubEdition.RuntimePlatform.Log {
    ...
    public class CyclicJobLog {
        ...
        public ObjectKey CyclicJobKey {
            get {
                return ObjectKey.Parse(log.CyclicJobKey);
            }
            set {
                log.CyclicJobKey = ObjectKeyUtils.DatabaseValue(value);
            }
        }
        public int EspaceId {
            get {
        ...
        public CyclicJobLog(DateTime instant, int duration, ObjectKey cyclicJobKey, int espaceId, int tenantId, string executedBy,
            ...
            log = new CyclicJobLogDefinition(instant, duration, cyclicJobKey, espaceId, tenantId, executedBy,
                errorId, shouldHaveRunAt, nextRun, requestKey, eSpaceName, applicationName, applicationKey, cyclicJobName, accessVisibility: LogAccessHelper.GetAccessVisibility(applicationKey));
        }
        ...
        public void Write(DateTime instant, int duration, ObjectKey cyclicJobKey, int espaceId, int tenantId,
            ...
            log.Write(instant, duration, ObjectKeyUtils.DatabaseValue(cyclicJobKey), espaceId, tenantId, executedBy, errorId, shouldHaveRunAt, nextRun, requestKey, 
                eSpaceName, applicationName, ObjectKeyUtils.DatabaseValue(applicationKey), cyclicJobName, accessVisibility: LogAccessHelper.GetAccessVisibility(applicationKey));
        }
