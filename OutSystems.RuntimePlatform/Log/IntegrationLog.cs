...
namespace OutSystems.HubEdition.RuntimePlatform.Log {
    ...
    public class IntegrationLog {
        ...
        private LogAccess.Visibility AccessVisibility {
            get {
                return log.AccessVisibility;
            }
            set {
                log.AccessVisibility = value;
            }
        }
        ...
        public IntegrationLog(IAppInfo appInfo, string id, DateTime instant, int duration, string source, string endpoint, string action, string type,
            string errorId, string executedBy, bool isExpose, bool hasDetail = false) {
            log = new IntegrationLogDefinition();
            ...
            HasDetail = hasDetail;
            AccessVisibility = LogAccessHelper.GetAccessVisibility(ApplicationKey);
        ...
        public static string StaticWrite(IAppInfo appInfo, DateTime instant, int duration, string source, string endpoint, string action, string type,
            string errorId, bool isExpose, bool hasDetail = false) {
            IntegrationLog log = new IntegrationLog();
            log.Write(appInfo, IntegrationLogDefinition.GenerateLogId(), instant, duration, source, endpoint, action, type, errorId, isExpose, hasDetail);
            return log.Id;
        }
