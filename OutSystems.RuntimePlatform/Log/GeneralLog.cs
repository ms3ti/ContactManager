...
namespace OutSystems.HubEdition.RuntimePlatform.Log {
    ...
    public class GeneralLog {
        ...
        public GeneralLog(DateTime instant, string sessionGuid, int espaceId, int tenantId, int userId, string message, string messageType, string moduleName, string errorId) {
            ...
            log = new GeneralLogDefinition(instant, sessionGuid, espaceId, tenantId, userId, message, messageType, moduleName,
                                            errorId, requestKey, actionName, entryPointName, clientIp,
                                            eSpaceName, applicationName, ObjectKeyUtils.DatabaseValue(applicationKey), username, accessVisibility: LogAccessHelper.GetAccessVisibility(applicationKey));
        }
        ...
        public void Write(DateTime instant, string sessionGuid, int espaceId, int tenantId, int userId,
            string message, string messageType, string moduleName, string errorId) {

            GetEspaceDetails(espaceId, userId, out string eSpaceName, out string applicationName, out ObjectKey applicationKey, out string username);

            Write(instant, sessionGuid, espaceId, tenantId, userId,
        ...
        public void Write(DateTime instant, string sessionGuid, int espaceId, int tenantId, int userId,
            ...
            log.Write(instant, sessionGuid, espaceId, tenantId, userId, message, messageType, moduleName,
                        errorId, requestKey, actionName, entryPointName, clientIp,
                        eSpaceName, applicationName, ObjectKeyUtils.DatabaseValue(applicationKey), username, accessVisibility: LogAccessHelper.GetAccessVisibility(applicationKey));
        }
