...
namespace OutSystems.HubEdition.RuntimePlatform.Log {
    ...
    public class ExtensionLog {
        ...
        public void Write(IAppInfo appInfo, ISessionInfo sessionInfo, DateTime instant, int duration, string action_name, int extensionId, string extensionName, string errorId) {
            ...
            log.Write(instant, duration, action_name, sessionInfo.SessionGuid, appInfo.eSpaceId, appInfo.TenantId, sessionInfo.UserId, extensionId, RuntimeEnvironment.MachineName, errorId, requestKey,
                appInfo.eSpaceName, extensionName, appInfo.ApplicationName, appInfo.ApplicationUIDAsKey, sessionInfo.UserName, accessVisibility: LogAccessHelper.GetAccessVisibility(appInfo.ApplicationUIDAsKey));
        }
