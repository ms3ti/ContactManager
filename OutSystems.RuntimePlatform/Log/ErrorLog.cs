...
namespace OutSystems.HubEdition.RuntimePlatform.Log {
    ...
    public class ErrorLog {
        ...
        public string SessionId {
            get {
                return log.SessionGuid;
            }
            set {
                log.SessionGuid = value;
            }
        }
        ...
        public const int MAX_SESSION_ID_SIZE = ErrorLogDefinition.MAX_SESSION_GUID_SIZE;
        ...
        public const int MAX_SERVER_SIZE = ErrorLogDefinition.MAX_SESSION_GUID_SIZE;
        ...
        public ErrorLog(string id, DateTime instant, string sessionGuid, int espaceId, int tenantId, int userId, string message,
        ...
        public void Write(string id, DateTime instant, string sessionGuid, int espaceId, int tenantId, int userId, string message, string stack,
            ...
            log.Write(instant, sessionGuid, espaceId, tenantId, userId, message, stack, environmentInformation, moduleName, requestKey, entrypointName, actionName,
                string.Empty, string.Empty, ObjectKeyUtils.DatabaseValue(ObjectKey.Dummy), string.Empty, accessVisibility: LogAccessHelper.GetAccessVisibility(ApplicationKey));
        }
        ...
        public static string StaticWrite(DateTime instant, string sessionGuid, int espaceId, int tenantId, int userId, string message,
            ...
            return StaticWrite(instant, sessionGuid, espaceId, tenantId, userId, message, stack, environmentInformation, moduleName, eSpaceName, applicationName, applicationKey, username);
        }
        ...
        public static string StaticWrite(DateTime instant, string sessionGuid, int espaceId, int tenantId, int userId, string message,
            ...
            return ErrorLogDefinition.StaticWrite(instant, sessionGuid, espaceId, tenantId, userId, message, stack, environmentInformation, moduleName, requestKey, entryPointName, actionName,
                eSpaceName, applicationName, applicationKey, username, extraFields: extraFields, accessVisibility: LogAccessHelper.GetAccessVisibility(applicationKey));
        }

        private static string StaticWriteWithId(string id, DateTime instant, string sessionGuid, int espaceId, int tenantId, int userId, string message, string stack,
                                    string environmentInformation, string moduleName, string requestKey, string entrypointName, string actionName) {
            ErrorLog log = new ErrorLog();

            log.Write(id, instant, sessionGuid, espaceId, tenantId, userId, message, stack, environmentInformation, moduleName, requestKey, entrypointName, actionName, false);
            return log.ErrorId;
        }
        ...
        private static ContextInfoForStack FillContextInfoStruct(HeContext context) {
            ...
            if (context != null) {
                try { contextForStack.sessionGuid = context.Session.SessionGuid; } catch { }
                ...
                try { contextForStack.requestUrl = context.CurrentHttpContext.Request.Url.ToString(); } catch { }
                try { contextForStack.requestMethod = context.CurrentHttpContext.Request.HttpMethod; } catch { }
                try {
                    contextForStack.requestQuery = context.CurrentHttpContext.Request.QueryString != null ? context.CurrentHttpContext.Request.QueryString.ToString() : "";
                } catch { }
        ...
        private static AppInfoForStack FillAppInfoStruct(AppInfo info, int overrideEspaceId, int overrideTenantId,
            ...
            if (info != null) {
                ...
                try { infoForStack.FeatureTogglesStateDuringCompilation = info.FeatureTogglesStateDuringCompilation; } catch { }
            }
            ...
            infoForStack.eSpaceName = overrideEspaceName ?? infoForStack.eSpaceName;
            infoForStack.applicationName = overrideApplicationName ?? infoForStack.applicationName;
            infoForStack.applicationKey = overrideApplicationKey ?? infoForStack.applicationKey;
