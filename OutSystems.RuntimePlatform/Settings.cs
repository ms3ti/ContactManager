...
namespace OutSystems.HubEdition.RuntimePlatform {
    using DatabaseConfigurations = DatabaseAbstractionLayer.Platform.Configuration.DatabaseConfigurations;
...
public class Configs {
    ...
    public const string SanitizeSpreadsheetFormulas = "OutSystems.HubEdition.SanitizeSpreadsheetFormulas";
    ...
    */
    public const string Cache_ControlPath = "Cache.ControlPath";
            ...
            public const string CacheProviderKey = "OutSystems.Plugin.Caching.CacheProviderKey";
            public const string EnableRabbitMQCacheInvalidation = "OutSystems.Plugin.RabbitMQ.Enable";

            public const string FileBasedCacheProviderKey = "OutSystems.Plugin.Caching.FileBasedCacheProviderKey";
    ...
    public static class ServiceLogs {
        public const string DeploymentController_LogLevel = "OutSystems.Server.DeploymentController.LogLevel";
        public const string DeploymentController_LogPath = "OutSystems.Server.DeploymentController.LogPath";
        public const string DeploymentService_LogLevel = "OutSystems.Server.DeploymentService.LogLevel";
        public const string DeploymentService_LogPath = "OutSystems.Server.DeploymentService.LogPath";
        public const string ServerAPI_LogLevel = "OutSystems.Server.API.LogLevel";
        public const string ServerAPI_LogPath = "OutSystems.Server.API.LogPath";
    }
    ...
    // IIS only
    public const string IIS_DefaultModulesApplicationPool = "IIS.DefaultApplicationPool";
    public const string IIS_DefaultApplicationsApplicationPool = "IIS.DefaultApplicationsApplicationPool";

    public const string IIS_DefaultServiceCenterApplicationPool = "IIS.DefaultServiceCenterApplicationPool";
    ...
    public const string Compiler_UseCacheInvalidationSuffix = "Compiler.UseCacheInvalidationSuffix"; // Possible values: none, platforminserted, usercss, all;
    ...
    public const string Compiler_UseFrontEndAddressRefreshPaths = "Compiler.UseFrontEndAddressRefreshPaths"; // RSCT-1960
    ...
    public const string CompilerService_MaxDegreeOfParallelism = "CompilerService.MaxDegreeOfParallelism";
    public const string CompilerService_EnableDeployDuringUpgrade = "CompilerService.EnableDeployDuringUpgrade";
    public const string CompilerService_EnableBarService = "CompilerService.EnableBarService";
    public const string CompilerService_BarPath = "CompilerService.BarPath";
     ...
     * one here */
            // FIXME: the following Remoting constants should be moved to RuntimePlatformSettings
    ...
    public const string CompilerService_RoslynCompilerLocation = "aspnet:RoslynCompilerLocation"; // This setting has this name to match the runtime setting that controls the Roslyn path location
    public const string CompilerService_CSharpCompiler = "CompilerService.CSharpCompiler";
    ...
    //Cloud Deploy (Kubernetes)
    public const string CloudDeployService_EnvironmentID = "CloudDeployService.EnvironmentID";
    ...
    public const string DeviceSettingsForceXhrCommunication = "Compiler.MobileRuntime.ForceXhrCommunication";
    ...
    public const string Email_SSLPort = "OutSystems.HubEdition.SMTP.SSLPort";
    ...
    public const string Scheduler_EnableDebuggerChecks = "Scheduler.EnableDebuggerChecks";
    ...
    // RRCT-2825 Fetch timeout values from machine.config
    public const string TokenRequestTimeoutInSeconds = "OutSystems.Request.TimeoutInSeconds";
    public const string TokenRequestFallbackTimeoutInSeconds = "OutSystems.Request.FallbackTimeoutInSeconds";
    ...
    public const string BPT_BatchAbnormalActivitiesToProcess = "BPT.BatchAbnormalActivitiesToProcess";

    public const string BPT_NumberAbnormalActivitiesPerProcess = "BPT.NumberAbnormalActivitiesPerProcess";

    public const string BPT_ProcessBackoffRetrybaseSec = "OutSystems.BPT.ProcessesBackoffRetrybaseSec";
    public const string BPT_ProcessBackoffConstant = "OutSystems.BPT.ProcessesBackoffConstant";
    ...
    // RSAT-1196 Shows/hides transaction isolation level in SC for SQL Server external DB connections
    public const string AllowTrxIsolationLevelSQLServer = "OutSystems.SC.AllowTrxIsolationLevelSQLServer";

    // RPD-4200 try to fix an issue when the server changes the server mode from production to development, because the server mode is '' on check
    public const string Fix_ConservativeApproachToServerModeChange = "Activation.Fix.ConservativeApproachToServerModeChange";

    // Flag used to enable isolated databases. It's also used in Service Center and Lifetime.
    public const string SupportsIsolatedDatabases = "SupportsIsolatedDatabases";

    public const string UseNewDatabaseDeploymentScripts = "OutSystems.CompilerService.UseNewDatabaseDeploymentScripts";
    public const string UseNewApplySettingsQuery = "OutSystems.CompilerService.UseNewApplySettingsQuery";

    //PLAPI-131 - This configurations must go to the database encrypted
    public const string EnableDatabase = "OutSystems.Logging.Database.Enable";
    public const string EnableFilebeat = "OutSystems.Logging.Filebeat.Enable";
    public const string FilebeatEndpoint = "OutSystems.Logging.Filebeat.Endpoint";
    public const string FilebeatMetadata = "OutSystems.Logging.Filebeat.Metadata";
...
public static class InMemorySession {
    private const string BaseKey = "OutSystems.Session.";
    private const string SessionProviders = "InMemorySessionProviders.";

    public const string UseInMemorySession = BaseKey + "UseInMemorySession";
    public const string ProviderKey = BaseKey + SessionProviders + "ProviderKey";
    public const string ConnectionString = BaseKey + SessionProviders + "ConnectionString";
}

public static class ServerAPIConfigs {
    public const string MinResponseDataRate = "OutSystems.Server.API.MinResponseDataRate";
    public const string MinRequestBodyDataRate = "OutSystems.Server.API.MinRequestBodyDataRate";
}

public static class ServerIdentityConfigs {
    public const string RefreshTokenLifetimeInSeconds = "OutSystems.Server.Identity.RefreshTokenLifetimeInSeconds";
    public const string AccessTokenLifetimeInSeconds = "OutSystems.Server.Identity.AccessTokenLifetimeInSeconds";
}

private static readonly HashSet<string> messageQueues = new HashSet<string> {
...
/// <summary>
/// Collection of settings that are specific to a node (in a farm environment) and stored in the DB
/// </summary>
private static readonly HashSet<string> nodeSettings = new HashSet<string> {
...
/// <summary>
/// Collection of settings that are specific to a node (in a farm environment) and stored in service .config files
/// </summary>
        public static readonly HashSet<string> serviceConfigSettings = new HashSet<string> {
                                                            Configs.CompilerService_ThirdPartyLibsDir,
                                                            Configs.CompilerService_RoslynCompilerLocation,
                                                            Configs.CompilerService_ConnectorsDirectory,
                                                            Configs.CompilerService_PublicationPath,
                                                            Configs.CompilerService_BarPath,
                                                            Configs.DotNetDeployService_TestDir,
                                                            Configs.DotNetDeployService_CustomHandlersDir,
                                                            Configs.OutgoingIPAddress,
                                                            Configs.IIS_DefaultModulesApplicationPool,
                                                            Configs.IIS_DefaultApplicationsApplicationPool,
                                                            Configs.IIS_DefaultServiceCenterApplicationPool,
...
defaultValues = new Dictionary<string, string>(350);
            ...
            defaultValues.Add(Configs.Compiler_UseFrontEndAddressRefreshPaths, "true"); // RSCT-1960
            ...
            defaultValues.Add(Configs.SanitizeSpreadsheetFormulas, "true");
            ...
            defaultValues.Add(Configs.CompilerService_CSharpCompiler, "framework");
            ...
            defaultValues.Add(Configs.Scheduler_EnableDebuggerChecks, "false");
            ...
            defaultValues.Add(Configs.IIS_DefaultModulesApplicationPool, "OutSystemsApplications");
            defaultValues.Add(Configs.IIS_DefaultApplicationsApplicationPool, "OutSystemsEntireApplications");
            defaultValues.Add(Configs.IIS_DefaultServiceCenterApplicationPool, "ServiceCenterAppPool");
            ...
            defaultValues.Add(Configs.TokenRequestTimeoutInSeconds, "110");
            defaultValues.Add(Configs.TokenRequestFallbackTimeoutInSeconds, "220");
            ...
            defaultValues.Add(Configs.Compiler_DotNetTargetFramework, "4.7.2");
            ...
            defaultValues.Add(Configs.UseShortRequestsOnDebugger, "false");
            ...
            defaultValues.Add(Configs.BPT_NumberAbnormalActivitiesPerProcess, "10000");
            defaultValues.Add(Configs.BPT_BatchAbnormalActivitiesToProcess, "100");
            defaultValues.Add(Configs.BPT_ProcessBackoffRetrybaseSec, "60");
            defaultValues.Add(Configs.BPT_ProcessBackoffConstant, "1.2");
            defaultValues.Add(Configs.ForceAppCacheUsage, "false");

            // NR Compile-time settings that affect behavior on device client runtime
            defaultValues.Add(Configs.DeviceSettingApplyTZForNullDates, "false");
            defaultValues.Add(Configs.DeviceSettingsForceXhrCommunication, "false");
            ...
            defaultValues.Add(Configs.AllowTrxIsolationLevelSQLServer, "false");

            defaultValues.Add(Configs.Fix_ConservativeApproachToServerModeChange, "false");

            defaultValues.Add(Configs.SupportsIsolatedDatabases, "false");
            defaultValues.Add(Configs.UseNewDatabaseDeploymentScripts, "true");
            defaultValues.Add(Configs.UseNewApplySettingsQuery, "true");

            defaultValues.Add(ServerAPIConfigs.MinRequestBodyDataRate, "");
            defaultValues.Add(ServerAPIConfigs.MinResponseDataRate, "");

            defaultValues.Add(ServerIdentityConfigs.AccessTokenLifetimeInSeconds, "");
            defaultValues.Add(ServerIdentityConfigs.RefreshTokenLifetimeInSeconds, "");

            defaultValues.Add(Configs.EnableDatabase, "true");
            defaultValues.Add(Configs.EnableFilebeat, "false");
            defaultValues.Add(Configs.FilebeatEndpoint, string.Empty);
            defaultValues.Add(Configs.FilebeatMetadata, string.Empty);

            //Cache
            defaultValues.Add(Configs.CacheProviderKey, "OutSystems.Plugin.RabbitMQPubSubCache");
            defaultValues.Add(Configs.EnableRabbitMQCacheInvalidation, "true");
            defaultValues.Add(Configs.FileBasedCacheProviderKey, "OutSystems.Plugin.FileBasedPubSubCache");
        }

        public static string GetDefaultValue(string key) {
    if (defaultValues.TryGetValue(key, out string defaultValue)) {
        return defaultValue;
    }
    return null;
}
...
/// </summary>
private static readonly HashSet<string> globalSettings = new HashSet<string> {
                                                                           ...
                                                                           InMemorySession.UseInMemorySession,
                                                                           InMemorySession.ProviderKey,
                                                                           InMemorySession.ConnectionString
                                                                       };

        public static string[] RequireCompileSettings {
            get {
                return requireCompileSettings.ToArray();
            }
        }
...
private static readonly HashSet<string> requireCompileSettings = new HashSet<string> {
                                                                Configs.DateFormat,
                                                                Configs.Compiler_DatabaseUnicodeSupport,
        ...
        public static string[] SharedSettings { get { return sharedSettings.ToArray(); } }

        public static string[] MessageQueues { get { return messageQueues.ToArray(); } }

        public static string[] NodeSettings { get { return nodeSettings.ToArray(); } }

        public static string[] VolatileSettings { get { return volatileSettings.ToArray(); } }

/* Here we are going to define witch settings are to be written in both places */

private static readonly HashSet<string> sharedSettings = new HashSet<string> {
                                                                           /* These configs must be on the config files to obtain the global settings */
                                                                           Configs.InstanceName,
                                                                       };

private static readonly HashSet<string> encryptedSettings = new HashSet<string> {
...
private static readonly HashSet<string> volatileSettings = new HashSet<string> {
                                                                        ...
                                                                        Configs.DotNet_SCProxyUserName,
                                                                        Configs.DotNet_SCProxyPassword,
                                                                        Configs.AllowTrxIsolationLevelSQLServer
                                                                  };
...
public static bool isNodeSetting(string name) {
    return nodeSettings.Contains(name);
}

        public static bool isServiceConfigSetting(string name) {
            return serviceConfigSettings.Contains(name);
}

public static bool isEncryptedSetting(string key) {
    return encryptedSettings.Contains(key);
}

public static bool isGlobalSetting(string key) {
    return globalSettings.Contains(key) || DatabaseConfigurations.IsSettingKey(key);
}

public static bool isRequireCompileSetting(string key) {
    return requireCompileSettings.Contains(key);
}

public static bool isSharedSetting(string key) {
    return sharedSettings.Contains(key);
}

public static bool isVolatileSetting(string key) {
    return volatileSettings.Contains(key);
}
...
public static bool isInitalizedPersistentSettings() {
    try {
        ...
        RuntimeCommon.Log.EventLogger.WriteError(ex);
...
public static bool GetBool(string key, Transaction trans) {
    foreach (var settingReaderOverride in settingReaderOverrides) {
        var result = settingReaderOverride.GetBool(key, out bool fallback);
        if (!fallback) {
            return result;
        }
    }
...
public static int GetInt(string key, Transaction transaction) {
    foreach (var settingReaderOverride in settingReaderOverrides) {
        var result = settingReaderOverride.GetInt(key, out bool fallback);
        if (!fallback) {
            return result;
        }
    }
...
public static decimal GetDecimal(string key) {
    foreach (var settingReaderOverride in settingReaderOverrides) {
        var result = settingReaderOverride.GetDecimal(key, out bool fallback);
        if (!fallback) {
            return result;
        }
    }
...
internal static string Get(string key, bool? isNodeSettingParam, bool? isEncryptedSettingParam, Transaction transaction, bool skipCache, bool cacheResult) {
    foreach (var settingReaderOverride in settingReaderOverrides) {
        string result = settingReaderOverride.Get(key, out bool fallback);
        if (isEncryptedSettingParam.HasValue ? isEncryptedSettingParam.Value : isEncryptedSetting(key)) {
            result = DecryptString(result);
        }
        if (!fallback) {
                    OSTrace.Debug("Settings:'{0}' is being accessed from a SettingReaderOverride with value '{1}'", key, result);
            return result;
        }
    }
    try {
        ...
        if (!skipCache && settingsCache.TryGetValue(key, out string resultFromCache)) {
                    OSTrace.Debug("Settings:'{0}' is being accessed from cache with value '{1}'", key, resultFromCache);
            return resultFromCache;
        }
        string retval = null;
        if (isGlobalSetting(key)) { // get from .config
            retval = GetGlobalSetting(key);
                    OSTrace.Debug("Settings:'{0}' is being accessed from machine.config with value '{1}'", key, retval);
                } else { // get from .database
            retval = ConfigurationManager.AppSettings[key];
                    OSTrace.Debug("Settings:'{0}' is being accessed from {1}.config with value '{2}'", key, "{service}", retval);
#if DETACHED_SCHEDULER
                    if (!isServiceConfigSetting(key) && retval == null) {
                        retval = GetParameter(key, isNodeSettingParam.HasValue ? isNodeSettingParam.Value : isNodeSetting(key), transaction);
                        OSTrace.Debug("Settings:'{0}' is being accessed from Database with value '{1}'", key, retval);
                    }
#endif
        }
        ...
        if (isEncryptedSettingParam.HasValue ? isEncryptedSettingParam.Value : isEncryptedSetting(key)) {
            retval = DecryptString(retval);
                    OSTrace.Debug("Settings:'{0}' has a decrypted value of '{1}'", key, retval);
        }

        if (retval == null) {
            retval = GetDefaultValue(key);
                    OSTrace.Debug("Settings:'{0}' is being accessed with default value of '{1}'", key, retval);
        }
        ...
        if (cacheResult && !isVolatileSetting(key)) {
                    OSTrace.Debug("Settings:'{0}' is being stored in cache with value '{1}'", key, retval);
        ...
        public static object GetEnvironmentConfiguration(Transaction tran, string configKey, bool isNodeSetting) {
            ...
            using (Command cmd = tran.CreateCommand(sql)) {
                cmd.CreateParameter("@NAME", configKey.ToUpperInvariant());
                if (isNodeSetting) {
                    cmd.CreateParameter("@HOSTSERIAL", RuntimePlatform.Internal.SettingsInternal.MachineSerial.ToUpperInvariant());
                }
