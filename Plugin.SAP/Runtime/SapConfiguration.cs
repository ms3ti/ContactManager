...
namespace OutSystems.Plugin.SAP {
    public class SapConfiguration {
        ...
        Func<SapConfiguration> fetchSettings = () => {
            ...
            var passwordSetting = RuntimePlatformSettings.Plugin.GetSetting<string>(pluginName, eSpaceKey, sapWebRefSSKey, "Effective_Password", String.Empty, isEncrypted: true);
